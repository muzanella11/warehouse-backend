...
class ChartArea {
    ...
    {
        // Add data chart
        $getData = $this->addData();        

        // Create image
        $image = $this->createImage($getData);
    ...
    public function createImage ($data)
    {
        ...
        $image->drawText(150, 35, "Average temperatureeeeeeeee", ["FontSize" => 20, "Align" => TEXT_ALIGN_BOTTOMMIDDLE]);
        ...
        $imageResult = $image->autoOutput("example.drawAreaChart.threshold.png");
